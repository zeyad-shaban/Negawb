...
class MyUserAdmin(UserAdmin):
    ...
    fieldsets = UserAdmin.fieldsets + (
        (None, {'fields': ('phone', 'bio', 'avatar','cover' , 'show_email', 'who_see_avatar', 'who_add_group', 'friends', 'followers', 'is_confirmed', 'allow_friend_request', 'homepage', 'hide_comments', 'hide_recommended_posts', 'hide_followed_posts',
