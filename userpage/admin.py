...
class MyUserAdmin(UserAdmin):
    ...
    fieldsets = UserAdmin.fieldsets + (
        (None, {'fields': ('friends', 'bio', 'avatar', 'show_email', 'who_see_avatar', 'who_add_group', 'followers', 'is_confirmed', 'allow_friend_request', 'hide_comments', 'hide_recommended_posts', 'chat_only_mode', 'hide_followed_posts', 'fixed_navbar',
