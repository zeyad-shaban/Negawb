    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('who_see_avatar', models.CharField(choices=[('none', 'No One'), ('friends', 'Friends only *Beta*'), ('everyone', 'Every One')], default='friends', max_length=30)),
                ...
                ('homepage_posts', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='categories.Category')),
